...
const NavMd = () => {
    return (
        <>
        <div className="w-full h-full flex justify-between items-center mt-3 px-1 gap-1 rounded-sm">
            <div className="flex flex-row items-center">
                <BiChevronLeft />
                <h3>Shang-Chi: The legend of the Ten Rings</h3>
            </div>
            <BiShareAlt />
        </div>
        </>
...
const NavLg = () => {
    return (
        <>
        <div className="w-full flex justify-between items-center mx-40 py-2">
            <div className="flex w-3/5">
                ...
                <div className="w-full flex items-center bg-white px-1 ml-5 gap-1 rounded-md">
                    <BiSearch />
            ...
            <div className="flex items-center gap-3">
                <span className="flex items-center text-gray-400 text-sm font-medium hover:bg-white cursor-pointer">
                    Gaya
                    <BiChevronDown />    
                </span>
...
const MovieNavBar = () => {
    return (
        ...
        <nav>
            ...
            <div className="hidden lg:hidden md:flex bg-gray-300 px-4 py-2">
                <NavMd />
            </div>
            <div className="hidden lg:flex bg-navCol-700 px-4 py-2">
                <NavLg />
            </div>
        </nav>
        </>
