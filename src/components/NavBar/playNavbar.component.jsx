    ...
    return (
        ...
        <div className="text-white flex justify-between items-center py-2">
            <div className="flex gap-2 items-center">
                ...
                <h1 className="text-xl">Plays in National Capital Region (NCR)</h1>
            </div>
...
const NavMd = () => {
    return (
        <>
        <div className="w-full flex justify-between items-center bg-white mt-3 px-1 gap-1 rounded-sm">
            <BiSearch />
