...
const EnterainmentCardSlider = () => {
    const EnterntainmentImages = [
        ...
        "https://in.bmscdn.com/discovery-catalog/collections/tr:w-800,h-800:ote-NyBFdmVudHM%3D,otc-FFFFFF,otf-Roboto,ots-64,ox-48,oy-320,ott-b:w-300/interactive-games-collection-202012041129.png",
    ...
    return (
        ...
        <Slider { ...settings }>
        {
            EnterntainmentImages.map((image) => (
                <EnterainmentCard src={image} alt={image}/>
            ))
        }
        </Slider>
        </>
